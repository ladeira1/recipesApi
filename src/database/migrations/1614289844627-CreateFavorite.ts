...
export class CreateFavorite1614289844627 implements MigrationInterface {
    name = 'CreateFavorite1614289844627'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "favorite" ADD CONSTRAINT "FK_dc4e12820d766dc3f5be3a5c34f" FOREIGN KEY ("recipeId") REFERENCES "Recipe"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
