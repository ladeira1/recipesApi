...
export class CreateReview1614202848683 implements MigrationInterface {
    name = 'CreateReview1614202848683'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "review" ("id" SERIAL NOT NULL, "content" character varying NOT NULL, "user_id" uuid, "recipe_id" integer, CONSTRAINT "PK_2e4299a343a81574217255c00ca" PRIMARY KEY ("id"))`);
