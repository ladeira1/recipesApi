...
export class CreateUserRating1613926576320 implements MigrationInterface {
    name = 'CreateUserRating1613926576320'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "UserRating" ("user_id" uuid NOT NULL, "recipe_id" integer NOT NULL, "rating" numeric NOT NULL, CONSTRAINT "PK_2cd5cb55addeb444099e35b35c9" PRIMARY KEY ("user_id", "recipe_id"))`);
