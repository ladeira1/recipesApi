...
export class CreateTableTest1613865588062 implements MigrationInterface {
    name = 'CreateTableTest1613865588062'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Step" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "content" varchar NOT NULL, "created_at" date NOT NULL, "recipe" integer)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_Step" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "content" varchar NOT NULL, "created_at" date NOT NULL, "recipe" integer, CONSTRAINT "FK_a23daf089de94ff42a3a2eb17f6" FOREIGN KEY ("recipe") REFERENCES "Recipe" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_Step"("id", "content", "created_at", "recipe") SELECT "id", "content", "created_at", "recipe" FROM "Step"`);
        await queryRunner.query(`DROP TABLE "Step"`);
        await queryRunner.query(`ALTER TABLE "temporary_Step" RENAME TO "Step"`);
        await queryRunner.query(`CREATE TABLE "temporary_Recipe" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(40) NOT NULL, "recipe_image_url" varchar, "description" varchar(200) NOT NULL, "ingredients" varchar(300) NOT NULL, "preparation_time" integer NOT NULL, "serves" integer NOT NULL, "rating" numeric NOT NULL, "created_at" date NOT NULL, "user_id" varchar, CONSTRAINT "UQ_3fe67de1b57e28c330f2d01a4bd" UNIQUE ("name", "user_id"), CONSTRAINT "FK_d8288e7cca05ed5e1c400f54a95" FOREIGN KEY ("user_id") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Step" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "content" varchar NOT NULL, "created_at" date NOT NULL, "recipe" integer)`);
        await queryRunner.query(`INSERT INTO "Step"("id", "content", "created_at", "recipe") SELECT "id", "content", "created_at", "recipe" FROM "temporary_Step"`);
