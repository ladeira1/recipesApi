...
export class UpdateRecipeTable21613789862810 implements MigrationInterface {
    name = 'UpdateRecipeTable21613789862810'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "temporary_Step" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "content" varchar NOT NULL, "recipe" integer)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_Step" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "content" varchar NOT NULL, "recipe" integer, CONSTRAINT "FK_a23daf089de94ff42a3a2eb17f6" FOREIGN KEY ("recipe") REFERENCES "Recipe" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_Step"("id", "content", "recipe") SELECT "id", "content", "recipe" FROM "Step"`);
        await queryRunner.query(`DROP TABLE "Step"`);
        await queryRunner.query(`ALTER TABLE "temporary_Step" RENAME TO "Step"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE "temporary_Recipe"`);
        await queryRunner.query(`ALTER TABLE "Step" RENAME TO "temporary_Step"`);
        await queryRunner.query(`CREATE TABLE "Step" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "content" varchar NOT NULL, "recipe" integer, CONSTRAINT "FK_a23daf089de94ff42a3a2eb17f6" FOREIGN KEY ("recipe") REFERENCES "Recipe" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "Step"("id", "content", "recipe") SELECT "id", "content", "recipe" FROM "temporary_Step"`);
        await queryRunner.query(`DROP TABLE "temporary_Step"`);
    }
